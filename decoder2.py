...
#     cred = credentials.Certificate('https://raw.githubusercontent.com/gadhalevy/verifier/mykey.json')
    cred = credentials.Certificate('https://github.com/gadhalevy/verifier/blob/master/decoder2.py')
...
def main():
    ...
    if st.sidebar.checkbox('Download movies from Firebase?'):
        ...
        for i,r in df.iterrows():
            group=r['group']
            file=r['file']
            download_blob('Movies/{}/{}/{}/{}_{}'.format(year, semester, maabada, group, file),'FromFb/{}_{}'.format(group,file))
